...
# Before running this file, make sure that prepare_GRU_inputs_dunnhumby.py is run in the same session and the trained GRU model basketGRU_dunnhumby.pth is obtained from the train_instacart.py file
...
checkpoint = torch.load("drive/MyDrive/GRU revision/basketGRU_dunnhumby.pth") # Load trained network
