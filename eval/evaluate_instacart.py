...
# Before running this file, make sure that prepare_GRU_inputs_instacart.py is run in the same session and the trained GRU model basketGRU_instacart.pth is obtained from the train_instacart.py file
